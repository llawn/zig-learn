...
- "Zig Programming Language" - Official Documentation

### Online Resources

- Zig official documentation and examples
- LeetCode for algorithm practice
- HackerRank for competitive programming
- GitHub for open-source Zig projects

### Communities

- [Zig](https://codeberg.org/ziglang/zig)
- [Ziglang](https://ziglang.org/)
- [Zig Discord server](https://discord.com/invite/zig)
- [Reddit r/Zig](https://www.reddit.com/r/Zig/)
- [Stack Overflow Zig tag](https://stackoverflow.com/questions/tagged/zig)
